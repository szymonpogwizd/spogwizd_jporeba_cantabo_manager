...
public class PlaylistDAO  extends Auditable<UUID>  {
    ...
    public PlaylistDAO(UUID id, String name, boolean defaultItem, Set<PlaylistCategoryDAO> playlistCategories, Set<SlideDAO> slides, Set<SongDAO> songs, Set<GroupDAO> groups) {
        this.id = id;
        this.name = name;
